...
const routes: Routes = [
  ...
  { path: 'admin/dashboard', component:AdminDashboardComponent, /*canActivate:[GuardGuard]*/ },
  { path: 'user/dashboard', component:UserDashboardComponent, /*canActivate:[GuardGuard]*/ },
